...
const initiatives = [
  ...
  },
  {
    ...
    points: [
      ...
      <>
        <b className="text-[#ED1C24]">Environment & Arts Education:</b> Ongoing
        engagement through NGOs and cultural foundations
      </>,
    ],
  },
];
...
export default function RecentInitiatives() {
  return (
    <div className="py-1 lg:px-0 px-5">
      <h6 className="text-2xl text-[#646464] font-light text-center pb-10">
      ...
      {initiatives.map((initiative, index) => (
        <div
          key={index}
          className="container mx-auto flex flex-col md:flex-row gap-7 border border-[#ED1C24] mb-10"
        >
          {/* Image Section */}
